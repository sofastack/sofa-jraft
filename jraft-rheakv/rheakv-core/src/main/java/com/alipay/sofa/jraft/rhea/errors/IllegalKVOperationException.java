...
public class IllegalKVOperationException extends RheaRuntimeException {
    ...
    public IllegalKVOperationException(String message) {
        super(message);
    }

    public IllegalKVOperationException(String message, Throwable cause) {
        super(message, cause);
    }

    public IllegalKVOperationException(Throwable cause) {
        super(cause);
    }
}
