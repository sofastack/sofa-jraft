...
public interface InboundHandler extends Handler {
    ...
    /**
     * Handles the specified inbound event.
     *
     * @param ctx   the context object for this handler.
     * @param event the inbound event to process or intercept.
     */
    void handleInbound(final HandlerContext ctx, final InboundMessageEvent<?> event) throws Exception;
}
