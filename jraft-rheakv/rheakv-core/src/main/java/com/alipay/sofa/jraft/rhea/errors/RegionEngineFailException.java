...
public class RegionEngineFailException extends ApiException {
    ...
    public RegionEngineFailException(String message) {
        super(message);
    }

    public RegionEngineFailException(String message, Throwable cause) {
        super(message, cause);
    }

    public RegionEngineFailException(Throwable cause) {
        super(cause);
    }
}
