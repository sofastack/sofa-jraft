...
public class RegionHeartbeatOutOfDateException extends ApiException {
    ...
    public RegionHeartbeatOutOfDateException(String message) {
        super(message);
    }

    public RegionHeartbeatOutOfDateException(String message, Throwable cause) {
        super(message, cause);
    }

    public RegionHeartbeatOutOfDateException(Throwable cause) {
        super(cause);
    }
}
