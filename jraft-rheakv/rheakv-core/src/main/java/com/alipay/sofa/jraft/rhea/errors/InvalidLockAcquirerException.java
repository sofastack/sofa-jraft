...
public class InvalidLockAcquirerException extends IllegalStateException {
    ...
    public InvalidLockAcquirerException(String s) {
        super(s);
    }

    public InvalidLockAcquirerException(String message, Throwable cause) {
        super(message, cause);
    }

    public InvalidLockAcquirerException(Throwable cause) {
        super(cause);
    }
}
