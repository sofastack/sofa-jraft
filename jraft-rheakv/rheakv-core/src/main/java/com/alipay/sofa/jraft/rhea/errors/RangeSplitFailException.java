...
public class RangeSplitFailException extends ApiException {
    ...
    public RangeSplitFailException(String message) {
        super(message);
    }

    public RangeSplitFailException(String message, Throwable cause) {
        super(message, cause);
    }

    public RangeSplitFailException(Throwable cause) {
        super(cause);
    }
}
