...
public class CallSelfEndpointException extends ApiException {
    ...
    public CallSelfEndpointException(String message) {
        super(message);
    }

    public CallSelfEndpointException(String message, Throwable cause) {
        super(message, cause);
    }

    public CallSelfEndpointException(Throwable cause) {
        super(cause);
    }
}
