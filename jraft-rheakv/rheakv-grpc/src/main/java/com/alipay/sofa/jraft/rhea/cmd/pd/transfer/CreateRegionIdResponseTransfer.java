...
public class CreateRegionIdResponseTransfer
    ...
    public CreateRegionIdResponse protoBufTransJavaBean(final RheakvPDRpc.CreateRegionIdResponse createRegionIdResponse)
        ...
        BaseResponseProtobufTransfer.protoBufTransJavaBean(response, createRegionIdResponse.getBaseResponse());
        response.setValue(createRegionIdResponse.getValue());
        return response;
    }

    @Override
    public RheakvPDRpc.CreateRegionIdResponse javaBeanTransProtobufBean(final CreateRegionIdResponse createRegionIdResponse)
                                                                                                                            throws CodecException {
