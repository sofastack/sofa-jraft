 ...
 */
public class MyRocksDBSegmentLogStorage extends MyLogStorage {
    ...
    private static final Logger LOG                            = LoggerFactory
            .getLogger(MyRocksDBSegmentLogStorage.class);
    ...
    public static class Builder {
        ...
        public MyRocksDBSegmentLogStorage build() {
            return new MyRocksDBSegmentLogStorage(this.path, this.raftOptions, this.valueSizeThreshold,
    ...
    public MyRocksDBSegmentLogStorage(final String path, final RaftOptions raftOptions) {
        this(path, raftOptions, DEFAULT_VALUE_SIZE_THRESHOLD, MAX_SEGMENT_FILE_SIZE);
    }

    public MyRocksDBSegmentLogStorage(final String path, final RaftOptions raftOptions, final int valueSizeThreshold,
    ...
    protected boolean onInitLoaded() {
        ...
        try {
            ...
            if (segmentFiles != null && segmentFiles.length > 0) {
                // Sort by sequences.
                Arrays.sort(segmentFiles, Comparator.comparing(MyRocksDBSegmentLogStorage::getFileSequenceFromFileName));
    ...
    protected void onTruncateSuffix(final long lastIndexKept) throws RocksDBException, IOException {
        ...
        try {
            ...
            long firstIndex = getFirstLogIndex();
