...
public class RaftOptions {
     ...
     *  If true, it would hurt the performance of JRAft.
     *  <strong>
     *  This option can only be set when setting up the raft cluster. If the cluster already setup, you can't change this option any more.
     *  </strong>
     *  @since 1.2.6
     */
    private boolean        enableLogEntryChecksumValidation = false;
    ...
    public boolean isEnableLogEntryChecksumValidation() {
        return this.enableLogEntryChecksumValidation;
    }

    public void setEnableLogEntryChecksumValidation(final boolean enableLogEntryChecksumValidation) {
        this.enableLogEntryChecksumValidation = enableLogEntryChecksumValidation;
    }
