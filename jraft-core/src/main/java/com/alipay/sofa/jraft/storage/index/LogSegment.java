 ...
 * @since 1.2.6
 */
public class LogSegment implements Lifecycle<LogSegment.SegmentFileOptions> {
    ...
    public static class SegmentFileOptions {
        ...
        public static SegmentFileOptions.Builder builder() {
            return new SegmentFileOptions.Builder();
        }
        ...
        public static class Builder {
            ...
            public SegmentFileOptions.Builder setRecover(final boolean recover) {
                this.recover = recover;
                return this;
            }

            public SegmentFileOptions.Builder setPos(final int pos) {
                this.pos = pos;
                return this;
            }

            public SegmentFileOptions.Builder setLastFile(final boolean isLastFile) {
                this.isLastFile = isLastFile;
                return this;
            }

            public SegmentFileOptions.Builder setNewFile(final boolean isNewFile) {
                this.isNewFile = isNewFile;
                return this;
            }

            public SegmentFileOptions.Builder setSync(final boolean sync) {
                this.sync = sync;
                return this;
            }
    ...
    public LogSegment(final int size, final String path, final ThreadPoolExecutor writeExecutor,
