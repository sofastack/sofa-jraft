...
public class FSMCallerImpl implements FSMCaller {
    ...
    public boolean init(final FSMCallerOptions opts) {
        ...
        this.nodeMetrics.recordSize("JRaft-FSMCaller-Disruptor", this.taskQueue.getBufferSize());
    ...
    private boolean enqueueTask(final EventTranslator<ApplyTask> tpl) {
        ...
        this.nodeMetrics.recordSize("JRaft-FSMCaller-Disruptor",
            this.taskQueue.getBufferSize() - this.taskQueue.remainingCapacity());
        return true;
    }
