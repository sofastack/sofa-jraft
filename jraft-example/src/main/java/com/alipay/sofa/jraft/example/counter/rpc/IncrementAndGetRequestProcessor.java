 ...
 */
public class IncrementAndGetRequestProcessor implements RpcProcessor<CounterRpc.IncrementAndGetRequest> {
    ...
    @Override
    public void handleRequest(final RpcContext rpcCtx, final CounterRpc.IncrementAndGetRequest request) {
