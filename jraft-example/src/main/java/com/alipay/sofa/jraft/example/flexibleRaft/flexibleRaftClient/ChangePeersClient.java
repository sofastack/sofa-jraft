...
public class ChangePeersClient {
    public static void main(String[] args) {
        CliService cliService = new CliServiceImpl();
        cliService.init(new CliOptions());
        String groupId = "counter";
        String oldConfStr = "127.0.0.1:8081,127.0.0.1:8082,127.0.0.1:8083,127.0.0.1:8084,127.0.0.1:8085,127.0.0.1:8086";
        ...
        if (!conf.parse(oldConfStr)) {
            throw new IllegalArgumentException("Fail to parse conf:" + confStr);
        }
        cliService.changePeers(groupId, oldConf, conf);
    }
}
