...
public final class ServerCallImpl<ReqT, RespT> extends ServerCall<ReqT, RespT> {
    ...
    ServerCallImpl(ServerStream stream, MethodDescriptor<ReqT, RespT> method, Metadata inboundHeaders,
                   ...
                   CompressorRegistry compressorRegistry, CallTracer serverCallTracer) {
        this.stream = stream;
        this.method = method;
    ...
    public void sendHeaders(Metadata headers) {
        ...
        byte[] advertisedEncodings = InternalDecompressorRegistry
            .getRawAdvertisedMessageEncodings(decompressorRegistry);
    ...
    static final class ServerStreamListenerImpl<ReqT> implements ServerStreamListener {
        ...
        public ServerStreamListenerImpl(ServerCallImpl<ReqT, ?> call, ServerCall.Listener<ReqT> listener,
            ...
            this.context.addListener(context1 -> ServerStreamListenerImpl.this.call.cancelled = true, MoreExecutors.directExecutor());
        }

        @SuppressWarnings("Finally")
        // The code avoids suppressing the exception thrown from try
        @Override
